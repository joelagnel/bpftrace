...
entry:
  ...
  %lookup_elem = call i8* inttoptr (i64 1 to i8* (%bpf_map*, i8*)*)(%bpf_map* %bpf_map_ptr, [8 x i8]* nonnull %"@x_key")
...
lookup_merge:                                     ; preds = %entry, %lookup_success
  ...
  %update_elem = call i64 inttoptr (i64 2 to i64 (%bpf_map*, i8*, i8*, i64)*)(%bpf_map* %bpf_map_ptr3, [8 x i8]* nonnull %"@x_key1", i64* nonnull %"@x_val", i64 0)
