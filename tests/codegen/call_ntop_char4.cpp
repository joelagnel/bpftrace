...
entry:
  ...
  %tmpcast8 = bitcast i64* %inet2 to [8 x i8]*
  %"@x_key1" = alloca i64, align 8
  %tmpcast7 = bitcast i64* %"@x_key1" to [8 x i8]*
  %inet = alloca i64, align 8
  %tmpcast6 = bitcast i64* %inet to [8 x i8]*
  ...
  store i32 2, [8 x i8]* %tmpcast6, align 8
  %3 = getelementptr inbounds [8 x i8], [8 x i8]* %tmpcast6, i64 0, i64 4
  ...
  %lookup_elem = call i8* inttoptr (i64 1 to i8* (%bpf_map*, i8*)*)(%bpf_map* %bpf_map_ptr, [8 x i8]* nonnull %tmpcast)
...
lookup_merge:                                     ; preds = %entry, %lookup_success
  ...
  store i32 2, [8 x i8]* %tmpcast8, align 8
  %8 = getelementptr inbounds [8 x i8], [8 x i8]* %tmpcast8, i64 0, i64 4
  ...
  %update_elem = call i64 inttoptr (i64 2 to i64 (%bpf_map*, i8*, i8*, i64)*)(%bpf_map* %bpf_map_ptr5, [8 x i8]* nonnull %tmpcast7, i64* nonnull %"@x_val", i64 0)
