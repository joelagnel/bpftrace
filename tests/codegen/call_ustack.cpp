...
entry:
  ...
  %get_stackid = tail call i64 inttoptr (i64 27 to i64 (i8*, %bpf_map*, i64)*)(i8* %0, %bpf_map* %bpf_map_ptr, i64 256)
  ...
  %get_stackid5 = call i64 inttoptr (i64 27 to i64 (i8*, %bpf_map*, i64)*)(i8* %0, %bpf_map* %bpf_map_ptr4, i64 256)
  %get_pid_tgid6 = call i64 inttoptr (i64 14 to i64 ()*)()
  %5 = shl i64 %get_pid_tgid6, 32
  %6 = or i64 %5, %get_stackid5
  ...
  %bpf_map_ptr8 = inttoptr i64 %pseudo7 to %bpf_map*
  %update_elem9 = call i64 inttoptr (i64 2 to i64 (%bpf_map*, i8*, i8*, i64)*)(%bpf_map* %bpf_map_ptr8, i64* nonnull %"@y_key", i64* nonnull %"@y_val", i64 0)
